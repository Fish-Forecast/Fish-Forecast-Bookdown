...
Let's fit the three best multivariate regression models.  Then we fit the three best lm models chosen via stepwise regression, exhaustive search or cross-validation:
