...
The basic idea with an exponential smoothing model is that your forecast of $x$ at time $t$, as opposed to the actual value of $x$ at time $t$, is a smoothed function of past $x$ values.
...
Our goal when fitting an exponential smoothing model is to find the weighting, the $\alpha$, that minimizes the forecast errors.
